    ...
    <div className="container-margin">
      <div>
        ...
        <p className="paragraph text-[#575756]  text-xl">
          ...
          assessment. Our Scoring Models are further strengthened by a unique
          Risk Calculation Matrix to assess several objective metrics, such as
          the Fixed Obligation to Income Ratio (FOIR) and the Loan-to-Value
          ratio (LTV).
        </p>
      </div>
      ...
      <div  className="mt-48">
        ...
        <p className="paragraph lg:w-[70%] text-[#575756]  text-xl">
          ...
          and repossession at different stages of delinquency to stem the flow
          and minimize losses. The introduction of the comprehensive collections
        ...
        <p className="paragraph text-[#575756]  text-xl">
          ...
          bounce predictions, all powered by AI and ML algorithms. It recommends
          collection strategies based on customer behavior, market trends,
          bureau data, customer response data, and digital data. the platform
          simplifies various tasks such as generating real-time payment links,
          providing immediate feedback & visit updates, and facilitating easy
          tracking of addresses with its built-in Google Maps integration.
          Integration of Credit Nirvana platform integrates with Automated
          reminders, online payment portals, and AI-powered chatbots offer
        ...
        <p className="paragraph  text-[#575756]  text-xl">
          ...
          regular reminders and conducting follow-ups via tele-calling, IVR,
          SMS, and interactive voice bots before due dates. Furthermore,
        ...
        <p className="paragraph  text-[#575756]  text-xl">
          ...
          repayment positively impacts their credit score, financial stability,
          and overall relationship with the lender. Additionally, emphasizing
          the potential drawbacks of late or missed payments, such as overdue
          interest, bounce fees, and negative impacts on creditworthiness,
        ...
        <p className="paragraph  text-[#575756]  text-xl">
          ...
          cash flows. This approach, combined with personalised discussions and
        ...
        <p className="paragraph text-[#575756]  text-xl">
          ...
          methods such as E-NACH registration.
        </p>
      </div>
...
export default NavigatingChallenges;
