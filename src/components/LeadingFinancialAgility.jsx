    ...
    <div className="container-margin">
      <div className="w-full mt-8">
        ...
        <p className="paragraph pt-6 font-medium subtitle-page lg:text-2xl text-[#0098b6] ">
          ...
          diversified approach to borrowing, we ensure a well-balanced
          asset-liability profile across various maturity periods. This approach
          has led to a record-breaking surge in our Assets Under Management
          (AUM) this year, demonstrating the accomplishment of our strategic
          goals.
        </p>
      </div>
      <div className="mt-4">
        ...
        <p className=" paragraph text-[#575756]  text-xl">
          ...
          portfolio has been consistent, which highlights the steady spending
          habits of our customers. Our effective credit risk management is also
        ...
        <p className=" paragraph text-[#575756]  text-xl">
          ...
          stable.annual incremental cost are part of this approach. The
          consistency in delinquency rates further underscores our capability to
          successfully underwrite a wide spectrum of clients.
        </p>
      </div>
      ...
      <div className="flex sm:flex-col sm:gap-2 md:gap-20 md:flex-row mt-8">
        <div>
          ...
          <p className="text-[#575756]">Asset Under Management (AUM)</p>
        </div>
        ...
        <div>
          ...
          <p className="text-[#575756]">
            Capital Adequacy Ratio (NHB Requirement:15.0%)
          </p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">0.50%</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">90+ DPD Loans on AUM</p>
        </div>
        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">1.03%</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Gross Stage 3</p>
        </div>
        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">0.79%</span>
          </h1>
          <div className="callout-line"></div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-8">
          ...
          <p className="paragraph text-[#575756]  text-xl">
            ...
            lakh. As of March 2024, retail consumers account for 99% of our live
            customer base. This deliberate focus on servicing both salaried and
        ...
        <p className="paragraph text-[#575756]  text-xl">
          ...
          Mahindra Bank and CRISIL Limited provided insights into global
          financial trends and our performance within the Affordable Housing
          Finance landscape. The event served as a platform to elucidate our
        ...
        <p className="paragraph text-[#575756]  text-xl">
          ...
          increasing from less than H10 crore to over H100 crore monthly run
          rate in FY 24. Besides these achievements, we successfully raised
          approximately H8,000 crore during the fiscal year, solidifying our
          position as a prominent player in the financial sector.
        </p>
        </div>
      ...
      <div className="flex sm:flex-col sm:gap-2 md:gap-20 md:flex-row mb-8 mt-8">
        ...
        <p className="paragraph text-[#575756]  text-xl">
          ...
          business plan. We believe that our granular and well-balanced
          portfolio, along with our quality-focused approach, positions us well
...
export default LeadingFinancialAgility;
