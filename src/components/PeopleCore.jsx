  ...
  return (
    <div>
      ...
      <p className="paragraph text-[#575756]">
        ...
        These measures contribute to a positive workplace culture, which has
      ...
      <p className="paragraph text-[#575756]">
        ...
        cohesive force that binds our people, organization, and vision together,
      ...
      <p className="paragraph text-[#575756]">
        ...
        diverse perspectives foster innovation, creativity, and a richer
        exchange of ideas. Our policies and practices are designed to create a
        welcoming environment. Our commitment to equal opportunity extends to
        career growth and development. We ensure that every employee, regardless
        of their background, has access to the same growth opportunities,
        training programs, mentorship, and advancement pathways. Internal
      ...
      <p className="paragraph text-[#575756]">
        ...
        positive workplace culture, which has also been awarded with accolades
      ...
      <p className="paragraph text-[#575756]">
        ...
        <p className="paragraph text-[#575756]">
          ...
          from their very first day. At SHFL, inclusivity and equitable
          representation are central to our strategy for sustained growth and
          excellence.
        </p>
      </p>
      <div className="flex gap-14">
        ...
        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">27% </span>years
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Diversity in Leadership roles</p>
          <br />
        </div>
      </div>
      <div className="flex items-start">
        <div className="">
          ...
          <p className="paragraph text-[#575756]">
            ...
            such as affordable network access, cashless OPD vouchers, fitness
            guidance, preventive health check-ups and unlimited medical
          ...
          <div>
            ...
            <p className=" paragraph text-[#575756]">
              ...
              and today, we’re approaching nearly 300 women employees. This
            ...
            <div>
              ...
              <p className="paragraph text-[#575756]">
                ...
                introduced the ‘Women’s Referral Program.’ This initiative
                offers a significant additional referral bonus to employees who
                refer talented women candidates for employment. Furthermore,
                we’ve identified key job positions specifically reserved for
                diversity hiring across different levels within our
              ...
              <p className="paragraph text-[#575756]">
                ...
                safe ride home if they have to work beyond regular hours,
                guaranteeing their safety during late shifts. Additionally,
                providing laptops to all women employees, regardless of their
              ...
              <p className="paragraph text-[#575756]">
                ...
                This small yet impactful initiative aims to ensure the health
              ...
              <p className="paragraph text-[#575756]">
                ...
                work late hours. We’ve partnered with Uber to provide safe
                transportation for women employees working late hours. Locations
                where Uber services are not available, they can avail the
                benefits of company-tied-up cab vendors. Through these
                partnerships, we ensure a secure commute home, providing peace
              ...
              <p className="paragraph text-[#575756]">
                ...
                designed to prioritize and support the overall health and
                well-being of our women employees. We understand the
                significance of early detection and overall well-being, and this
              ...
              <p className="paragraph text-[#575756]">
                ...
                culture of appreciation and empowerment among women employees.
                These initiatives not only signify our dedication but also
                underscore our belief in fostering a culture of inclusivity,
                diversity, and empowerment, ensuring that every woman at SHFL
                feels valued, supported, and empowered to succeed.
              </p>
              <div>
                <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
                  <span className="text-5xl">314 </span>
                </h1>
                <div className="callout-line2"></div>
                <p className="text-[#575756]">
                  Women employees
                  <br />
                  (92.63% Y-o-Y increase)
                </p>
                <br />
                ...
                <p className=" paragraph text-[#575756]">
                  ...
                  encouraging and empowering them. This recognition has helped
                ...
                <p className=" paragraph text-[#575756]">
                  ...
                  for the second year in a row, we have been recognised as one
                  of India’s Top 50 Best Workplaces in BFSI 2024. This
                  accomplishment demonstrates our dedication to providing our
                  team members with a conducive work environment. The employee
                  engagement score reflects the collective commitment of our
                ...
                <h1 className="text-[#7cc4a9] font-extrabold text-2xl mt-8">
                ...
                <p className=" paragraph text-[#575756]">
                  ...
                  members with bonuses, promotions, monthly incentives and even
            ...
            <div className="flex gap-20"> 
              ...
              <div>
              <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
              Ravi as<span className="text-5xl">Top 25 </span>CEO
                </h1>
                <div className="callout-line"></div>
                <p className="text-[#575756]">
                Ravi Subramanian   
                  <br />
                  recognized as Top 25 CEO
                </p>
              </div>
              </div>
