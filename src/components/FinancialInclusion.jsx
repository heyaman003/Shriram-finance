    ...
    <div className="container-margin mt-8 mb-8">
      ...
      <div>
        ...
        <p className=" paragraph text-[#575756]  text-xl">
          ...
          Also, we are geared to expand our national footprint and engage more
          with customers. With our commitment to provide faster turnaround to
          our customers, we have decentralised credit functions while cautiously
          venturing into new states to ensure our long-term growth.
        </p>
      </div>
      ...
      <div className="flex sm:flex-col sm:gap-2 md:gap-20 md:flex-row">
        <div>
          ...
          <p className="text-[#575756]">Y-o-Y increase in AUM</p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">83%</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Y-o-Y growth in disbursements</p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">155</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Branches</p>
        </div>
        ...
        <div>
          ...
          <div className="callout-line"></div>
          <p className="text-[#575756]">States</p>
        </div>
      ...
      <div className="mt-8">
        ...
        <p className=" paragraph text-[#575756]  text-xl">
          ...
          on agents and enhances collection efficiency. Automated reminders and
        ...
        <p className=" paragraph text-[#575756]  text-xl">
          ...
          introduction of a Central Credit Team enhances efficiency from login
          to sanction, marking a significant step forward in our digital
          transformation journey. Zero interest or penalties on taxes and NHB
          compliance further reinforce our commitment to customer-centric
          practices.
        </p>
      </div>
      ...
      <div className="flex sm:flex-col sm:gap-2 md:gap-20 md:flex-row mb-8">
        <div>
          ...
          <div className="callout-line"></div>
          <p className="text-[#575756]">Customers served</p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">79,000+</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Downloads of the SHFL Home Loans App</p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">19,000+</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Active Users</p>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className=" paragraph text-[#575756]  text-xl">
          ...
          financial tools they need to achieve stability and fulfil their dreams
          of owning a home.
        </p>
      </div>
      ...
      <div className="flex sm:flex-col sm:gap-2 md:gap-20 md:flex-row mt-8 mb-8">
        <div>
          ...
          <div className="callout-line"></div>
          <p className="text-[#575756]">Women Loan Applicants</p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">74%</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">EWS/LIG/MIG Customers</p>
        </div>

        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">77%</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756] w-40">Ticket size &lt; 25L</p>
        </div>
        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">78%</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">Self-employed customers</p>
        </div>
        <div>
          <h1 className="text-[#7cc4a9] font-extrabold text-2xl">
            <span className="text-5xl">5,542</span>
          </h1>
          <div className="callout-line"></div>
          <p className="text-[#575756]">NHB refinance benefitted</p>
        </div>
